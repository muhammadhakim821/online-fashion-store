  ...
  return (
    <>
      <section className='section__container bg-primary-light'>
        ...
        <p className='section__subheader'>Discover the hottest pick: Elevate your style with our curate collection of Trending woman's Fashion products</p>
    </section>
    <section className='section__container'>
        <div className='flex flex-col md:flex-row md:ga-12 gap-8'>
            {/* left side  */}
            <div>
